      ...
      <main>
        ...
        <section className="py-8 sm:py-12 relative">
          ...
          <div className="container mx-auto px-4">
            ...
            {/* Quick Tips Card - Full width, responsive */}
            <motion.div 
              className="w-full max-w-4xl mx-auto relative overflow-hidden rounded-xl border-2 border-primary/30 bg-gradient-to-br from-primary/10 via-background to-accent/10 p-4 sm:p-6 shadow-lg shadow-primary/5"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 text-sm">
                  ...
                  <motion.div 
                    className="flex items-start gap-3 p-3 rounded-lg bg-background/50 border border-border/50 hover:border-primary/30 transition-colors sm:col-span-2 lg:col-span-1"
                    whileHover={{ x: 4 }}
                  >
