-- Update create_temp_email function to use subscription_tiers for expiry and limits
...
BEGIN
  ...
  ELSE
    ...
    -- Note: For guests, we don't enforce max_temp_emails server-side 
    -- (handled via localStorage client-side)
  END IF;
...
-- Enable realtime for subscription_tiers so changes propagate instantly
